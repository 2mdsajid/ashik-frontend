    ...
    return (
        <div className='max-w-3xl mx-auto'>
            <div className='flex flex-col gap-2 mb-5'>
                <h1 className='text-3xl tracking-wider font-semibold'>Conceptual Cee</h1>
                <p className=''>Dive into the world of competitive exam preparation with our latest guidebook tailored for the Common Entrance Examination (CEE). This comprehensive book is meticulously crafted to be your go-to resource, offering a strategic approach to mastering key concepts and enhancing problem-solving skills.</p>
                <p></p>
            </div>
            <Form {...form}>
